...
# 🚨 This must be the PRIMARY handler for OPTIONS
app.add_middleware(
    CORSMiddleware,
...
# -----------------------------------------------------------
# ❌ DELETE the 'short_circuit_options' middleware entirely.
#    It is preventing CORSMiddleware from adding headers.
# -----------------------------------------------------------

# -----------------------------------------------------------
# ❌ DELETE the @app.options("/api/v1/import/google-drive") route.
#    It is not needed and can cause conflicts.
# -----------------------------------------------------------
